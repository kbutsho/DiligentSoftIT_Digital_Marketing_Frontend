...
const RichTextEditor = dynamic(() => import('@/components/Editor/Editor'), { ssr: false });
...
export default function DashboardBlogPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.get(`${CONFIG.BackendURL}/api/blog`, { params: data });
  ...
  const handleAddDescriptionChange = (newContent) => {
    setFormData((prevState) => ({
      ...prevState, // Spread previous state
      description: newContent, // Only update the description
      errors: {
        ...prevState.errors, // Keep previous errors
        description: null, // Reset description error
      },
    }));
  };
  const handleFormSubmit = async (event) => {
    ...
    postData.append('meta_tag', formData.meta_tag);
    ...
    try {
      ...
      const response = await axios.post(`${CONFIG.BackendURL}/api/blog/create`, postData,
        {
          headers: {
  ...
  const handleDelete = async () => {
    try {
      const token = Cookies.get('token');
      const response = await axios.delete(`${CONFIG.BackendURL}/api/blog/${deleteItem?.id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const handleUpdateDescriptionChange = (newContent) => {
  ...
  const handleFormUpdate = async (e) => {
    ...
    postData.append('slug', updateItem.slug);
    postData.append('description', updateItem.description);
    postData.append('meta_tag', updateItem.meta_tag);
    postData.append('meta_description', updateItem.meta_description);
    postData.append('meta_title', updateItem.meta_title);
    if (updateItem.image) {
    ...
    try {
      ...
      const response = await axios.post(`${CONFIG.BackendURL}/api/blog/update`, postData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'multipart/form-data',
  ...
  return (
    <div className="py-4">
      <h4 className="mb-4">Blog List</h4>
      ...
      <div className="d-flex flex-wrap align-items-center gap-3 mb-4">
        ...
        <div>
          <button className="btn btn-outline-primary btn-sm py-2" onClick={toggleAddModal}>Add Blog</button>
        </div>
      </div>
              ...
              <tbody>
                {data.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td className='text-center'>{item.meta_title}</td>
                    <td className='text-center'>{item.meta_tag}</td>
                    <td className='text-center'>{item.meta_description}</td>
                    <td
                      className="text-center blog-description"
      ...
      <div>
        <Modal show={addModal} onHide={toggleAddModal} size="xl" centered>
          <Modal.Body>
            <div className="p-2">
              <div className="d-flex justify-content-between py-3">
                <h4 className="text-uppercase fw-bold">Add Blog</h4>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${formData?.errors?.slug ? 'is-invalid' : ''}`}
                    />
                    <div className="invalid-feedback">{formData?.errors?.slug}</div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <label className="form-label">Meta Tag <span className="text-danger">*</span></label>
                    <input
                      name="meta_tag"
                      type="text"
                      placeholder=""
                      onChange={handleChange}
                      className={`form-control ${formData?.errors?.meta_tag ? 'is-invalid' : ''}`}
                    />
                    <div className="invalid-feedback">{formData?.errors?.meta_tag}</div>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      placeholder=""
                      onChange={handleChange}
                      className={`form-control ${formData?.errors?.meta_title ? 'is-invalid' : ''}`}
                    />
                    <div className="invalid-feedback">{formData?.errors?.meta_title}</div>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      placeholder=""
                      onChange={handleChange}
                      className={`form-control ${formData?.errors?.meta_description ? 'is-invalid' : ''}`}
                    />
                    <div className="invalid-feedback">{formData?.errors?.meta_description}</div>
                  </div>

                  <div className="col-md-12">
                    <label className="form-label">Description <span className="text-danger">*</span></label>
                    <RichTextEditor onChange={handleAddDescriptionChange}
                    />
                    <small className='text-danger'>{formData?.errors?.description}</small>
                  </div>
                </div>
        ...
        <Modal show={updateModal} onHide={() => {
          ...
          <Modal.Body>
            <div className="p-2">
              <div className="d-flex justify-content-between py-3">
                <h4 className="text-uppercase fw-bold">Update blog</h4>
                <i role="button" aria-label="Close"
                  onClick={() => {
                    setUpdateModal(false); // Close the modal
                    setUpdateItem({
                      id: '',
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      name="slug"
                      type="text"
                      value={updateItem.slug}
                      placeholder=""
                      onChange={handleUpdateFormChange}
                      className={`form-control ${updateItem?.errors?.slug ? 'is-invalid' : ''}`}
                    />
                    <div className="invalid-feedback">{updateItem?.errors?.slug}</div>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      name="meta_tag"
                      type="text"
                      value={updateItem.meta_tag}
                      placeholder=""
                      onChange={handleUpdateFormChange}
                      className="form-control"
                    />
                    <div className="invalid-feedback">{updateItem?.errors?.meta_tag}</div>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      name="meta_title"
                      type="text"
                      value={updateItem.meta_title}
                      placeholder=""
                      onChange={handleUpdateFormChange}
                      className="form-control"
                    />
                    <div className="invalid-feedback">{updateItem?.errors?.meta_title}</div>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      name="meta_description"
                      type="text"
                      value={updateItem.meta_description}
                      placeholder=""
                      onChange={handleUpdateFormChange}
                      className="form-control"
                    />
                    <div className="invalid-feedback">{updateItem?.errors?.meta_description}</div>
                  </div>

                  <div className="col-md-12">
                    <label className="form-label">Description <span className="text-danger">*</span></label>
                    <RichTextEditor value={updateItem.description} onChange={handleUpdateDescriptionChange} />
