...
const DashboardTestimonialPage = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.get(`${CONFIG.BackendURL}/api/testimonial`, { params: data });
    ...
    const handleFormSubmit = async (event) => {
        ...
        postData.append('profession', formData.profession);
        ...
        try {
            ...
            const response = await axios.post(`${CONFIG.BackendURL}/api/testimonial/create`, postData,
                {
                    headers: {
    ...
    const handleDelete = async () => {
        try {
            const token = Cookies.get('token');
            const response = await axios.delete(`${CONFIG.BackendURL}/api/testimonial/${deleteItem?.id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleFormUpdate = async (e) => {
        ...
        postData.append('profession', updateItem.profession)
        postData.append('message', updateItem.message)
        if (updateItem.image) {
        ...
        try {
            ...
            const response = await axios.post(`${CONFIG.BackendURL}/api/testimonial/update`, postData,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                        'Content-Type': 'multipart/form-data',
    ...
    return (
        <div className="py-4">
            <h4 className="mb-4">Testimonial List</h4>
            ...
            <div className="d-flex flex-wrap align-items-center gap-3 mb-4">
                ...
                <div>
                    <button className="btn btn-outline-primary btn-sm py-2" onClick={toggleAddModal}>Add Testimonial</button>
                </div>
            </div>
            ...
            <div>
                    ...
                    <Modal.Body>
                        <div className="p-2">
                            <div className="d-flex justify-content-between py-3">
                                <h4 className="text-uppercase fw-bold">Add Testimonial</h4>
                            ...
                            <form onSubmit={handleFormSubmit} className="pt-3" encType="multipart/form-data">
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6">
                                        <label className="form-label">Profession <span className="text-danger">*</span></label>
                                        <input
                                            name="profession"
                                            type="text"
                                            placeholder="e.g., Developer"
                                            onChange={handleChange}
                                            className={`form-control ${formData?.errors?.profession ? 'is-invalid' : ''}`}
                                        />
                                        <div className="invalid-feedback">{formData?.errors?.profession}</div>
                                    </div>
                                    <div className="col-md-12">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            className={`form-control ${formData?.errors?.message ? 'is-invalid' : ''}`} />
                                        <div className="invalid-feedback">{formData?.errors?.message}</div>
                                    </div>
                                    <div className="col-md-12">
                ...
                <Modal show={updateModal} onHide={() => setUpdateModal(false)} size="lg" centered>
                    <Modal.Body>
                        <div className="p-2">
                            <div className="d-flex justify-content-between py-3">
                                <h4 className="text-uppercase fw-bold">Update Testimonial</h4>
                                ...
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            name="profession"
                                            type="text"
                                            value={updateItem.profession}
                                            placeholder="e.g., Developer"
                                            onChange={handleUpdateFormChange}
                                            className={`form-control ${updateItem?.errors?.profession ? 'is-invalid' : ''}`}
                                        />
                                        <div className="invalid-feedback">{updateItem?.errors?.profession}</div>
                                    </div>
                                    <div className="col-md-12">
                                        <label className="form-label">Message <span className="text-danger">*</span></label>
                                        <textarea
                                            name="message"
                                            rows={6}
                                            value={updateItem.message}
                                            placeholder="Write something..."
                                            onChange={handleUpdateFormChange}
                                            className={`form-control ${updateItem?.errors?.message ? 'is-invalid' : ''}`} />
                                        <div className="invalid-feedback">{updateItem?.errors?.message}</div>
                                    </div>
                                    <div className="col-md-12">
                                        <label className="form-label">Profile Photo</label>
                                        <input
